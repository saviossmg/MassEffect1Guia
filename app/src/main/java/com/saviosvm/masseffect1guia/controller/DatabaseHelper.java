...
public class DatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    private static String DBPATH = "/data/data/com.saviosvm.masseffect1guia/databases/";

    // Este é o nome do banco de dados que iremos utilizar
    private static String DBNAME ="MEGuide.db";
     ...
     */
        super(context, "MEGuide.db", null, 1);
    ...
    private void copyDatabase() throws IOException {
        ...
        InputStream dbInputStream = context.getAssets().open("MEGuide.db");
